...
public class ArabicPhoneticMatcher {
    ...
    public static func normalizeArabic(_ text: String) -> String {
        var normalized = text
    ...
    public static func isPhoneticMatch(_ spoken: String, _ expected: String) -> Bool {
